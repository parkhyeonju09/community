...
<div class="passbox">
	...
	<c:choose>
		<c:when test="${param.mode eq 'edit' }">
			<form name="passform" action="community/board/edit" method="post"></form>		
		</c:when>
		<c:otherwise>
			<form name="passform" action="community/board/delete" method="post"></form>		
		</c:otherwise>
	</c:choose>
	<input type="password" name="password" class="form-control">
	<input type="hidden" name="id" value="${param.id }" />
	<input type="hidden" name="id" value="${param.bid }" />
